            ...
            <div class="p-6 bg-white rounded-md shadow-md">
                <h2 class="text-lg text-gray-700 font-semibold capitalize">Данные заявление</h2>
                    ...
                    <div class="flex justify-end mt-4 gap-4">
                        ...
                        @if($claim->status > 3 && $claim->status < 6 && Auth::user()->region_id == 12 )
                            <a href="{{route('claim.tech', $claim->id)}}" class="px-4 py-2 bg-yellow-800 text-white rounded-md hover:bg-yellow-700 focus:outline-none focus:bg-yellow-700 flex items-center gap-4">
                                Заменить Тех. Условие
                            </a>
                        @endif
